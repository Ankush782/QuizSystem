       ...
       meta charset="UTF-8">
        ...
        <script>
            ...
            var x = setInterval(function() {
                ...
                var s=d%60;
                d=d-1;
            document.getElementById("t").innerHTML = m +"M:"+s+"S";
            if (d < 0) {
              clearInterval(x);
    ...
    <div class="navbar-header">
      ...
      <div class="container-fluid">
          <div class="well text-center">
             <h2>Quiz 50<span class="btn-danger pull-right" style="padding: 5px;"><% 
                  int id=Integer.parseInt(request.getSession().getAttribute("id").toString());
                  Class.forName("com.mysql.jdbc.Driver");
             Connection  con =DriverManager.getConnection("jdbc:mysql://localhost:3306/nursing","root","admin");
             Statement stmt=con.createStatement();  
             ResultSet rs=stmt.executeQuery("select quiz50 from performace where id="+Integer.toString(id)); 
             rs.next();
             int index=rs.getInt("quiz50");
      ...
      <form action="answerquiz50.jsp" method="get" name="refreshForm">
          ...
          <%
             ...
             index=1;
              rs=stmt.executeQuery("select * from questions  order by RAND() LIMIT 50");
            ...
            request.getSession().setAttribute("no", index-1);
             request.getSession().setAttribute("quiz", "quiz50");
              }catch(Exception e)
              {
                  out.write("<div class=\"well\">");
