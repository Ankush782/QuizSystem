    ...
    <div class="navbar-header">
      ...
      <div class="container-fluid">
          <div class="well text-center">
             <h2>Level 265<span class="btn-danger pull-right" style="padding: 5px;"><% 
                  int id=Integer.parseInt(request.getSession().getAttribute("id").toString());
                %></span></h2>
          </div>
      </div>
      <form action="level265.jsp" method="get" name="refreshForm">
          ...
          <% 
             ...
             ps.executeUpdate();
             ResultSet rs=stmt.executeQuery("select level265 from performace where id="+Integer.toString(id)); 
             rs.next();
              index=rs.getInt("level265");
             
                  out.write("<form action=\"answerquiz50.jsp\" method=\"get\">");
                  ...
                  out.write("<a href=\"answerquiz50.jsp\" style=\"decoration:none\"><input type=\"button\" class=\"btn btn-danger pull-right\" value=\"Discription\"></a>");
                  out.write("</div");
                  out.write("</form");
